...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_ABRE_CHAVE = 8,                 /* ABRE_CHAVE  */
  YYSYMBOL_FECHA_CHAVE = 9,                /* FECHA_CHAVE  */
  YYSYMBOL_PONTO_VIRGULA = 10,             /* PONTO_VIRGULA  */
  YYSYMBOL_ABRE_PARENTESE = 11,            /* ABRE_PARENTESE  */
  YYSYMBOL_FECHA_PARENTESE = 12,           /* FECHA_PARENTESE  */
  YYSYMBOL_E = 13,                         /* E  */
  YYSYMBOL_OU = 14,                        /* OU  */
  YYSYMBOL_NAO = 15,                       /* NAO  */
  YYSYMBOL_16_ = 16,                       /* '%'  */
